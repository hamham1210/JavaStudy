...
public class OutletService {
	...
	/*메소드 오버로딩 = 하는 일은 같지만 처리하는 데이터는 다르게 하는 기법.(규칙 1. 메소드이름은 같고 2. 인자값list은 다르다.(인자값의 타입이 다르게한다.) 3. return타입은 상관없다.)
	/인자 값이 다르므로 충돌이 안 난다. 서비스 클래스에서 기능의 일관성을 유지하는 중요한 기법이다.
	 * -인자값이 다른 경우는 by를 써라. 넓은 의미의 오버로딩
	 */
