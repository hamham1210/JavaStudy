...
public class MyProductController {
	...
	public ModelAndView findProduct(String command, String word) throws Exception {
		...
		/*
		 * MyProduct myProduct = new MyProduct();  if
		 * (command.equals("findProductByName")) { myProduct.setName(word); }else if
		 * (command.equals("findProductByMaker")) { myProduct.setMaker(word); } list =
		 * myProductDAO.findProducts(myProduct);
		 */
		list = myProductDAO.findProducts(command, word);
