 ...
 * 
 * Board와 Member 클래스 간의 Relation이 지정되어있다.
 * Has a Relation ... DI
 */
public class Board {
	...
	private int count;
	private String writeDate;//컬럼명 다름
	
	private Member member;//Has a Relation..? ResultMap을 어떻게 설정해야할지...
	...
	public Member setMemberVO(Member member) {
